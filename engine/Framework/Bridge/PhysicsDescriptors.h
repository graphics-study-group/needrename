#ifndef FRAMEWORK_BRIDGE_PHYSICSDESCRIPTORS_INCLUDED
#define FRAMEWORK_BRIDGE_PHYSICSDESCRIPTORS_INCLUDED
...
#endif // FRAMEWORK_BRIDGE_PHYSICSDESCRIPTORS_INCLUDED
