...
namespace Engine {
    ...
    public:
         ...
         * specified by the `color_attachment_format` parameter of `CreateVulkanBackend()` call. If a previously 
         * used attachment is used again, synchronization barriers must be set up correctly.
         */
         ...
         * This method only initalizes ImGUI front-end states. To actually render anything you need to create
         * the Vulkan backend by calling `CreateVulkanBackend()` method with attachment formats.
         */
        void Create(SDL_Window * window);

        /**
         * @brief Update the attachment formats for GUI rendering pipeline
         * by re-initializing the ImGUI Vulkan backend.
         * 
         * @param color_attachment_format Format of the color attachment. If UNDEFINED will use swapchain format.
         */
