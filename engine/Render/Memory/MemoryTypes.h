...
namespace Engine {
    ...
    namespace MemoryTypes {
        /**
         * @brief Allowed memory access types of buffer.
         */
        enum class BufferTypeBits {
            /// This buffer can be transfered from.
            CopyFrom = 1 << 0,
            /// This buffer can be transfered to.
            CopyTo = 1 << 1,
            ...
            /// @note If host random access is enabled, the buffer may be
            /// automatically mapped to the host VM on creation.
        ...
        /**
         * @brief Allowed memory access types of image.
         */
