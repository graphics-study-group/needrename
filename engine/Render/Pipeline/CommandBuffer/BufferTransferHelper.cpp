...
namespace Engine {
    ...
    std::pair<vk::PipelineStageFlagBits2, vk::AccessFlags2> BufferTransferHelper::GetScope1(BufferTransferType type) {
        ...
        case BufferTransferType::ReadonlyStorageBefore:
            return std::make_pair(vk::PipelineStageFlagBits2::eFragmentShader, vk::AccessFlagBits2::eShaderStorageRead);
        case BufferTransferType::ReadonlyStorageAfter:
            return std::make_pair(vk::PipelineStageFlagBits2::eTransfer, vk::AccessFlagBits2::eTransferWrite);
        case BufferTransferType::ClearAfter:
            return std::make_pair(vk::PipelineStageFlagBits2::eClear, vk::AccessFlagBits2::eTransferWrite);
        default:
    ...
    std::pair<vk::PipelineStageFlagBits2, vk::AccessFlags2> BufferTransferHelper::GetScope2(BufferTransferType type) {
        ...
        case BufferTransferType::ReadonlyStorageBefore:
            return std::make_pair(vk::PipelineStageFlagBits2::eTransfer, vk::AccessFlagBits2::eTransferWrite);
        case BufferTransferType::ReadonlyStorageAfter:
            return std::make_pair(vk::PipelineStageFlagBits2::eVertexShader, vk::AccessFlagBits2::eShaderStorageRead);
        case BufferTransferType::ClearAfter:
