...
namespace Engine {
    ...
    GraphicsContext::GraphicsContext(RenderSystem &system, vk::CommandBuffer cb, uint32_t frame_in_flight) :
        TransferContext(system, cb, frame_in_flight),
        pimpl(std::make_unique<GraphicsContext::impl>(GraphicsCommandBuffer(system, cb, frame_in_flight))) {
    }
