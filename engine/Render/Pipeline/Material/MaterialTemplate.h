...
namespace Engine {
    ...
    public:
         ...
         * 
         * @return const decltype(m_passes) & A
         * reference to a constant unordered_map containing all pass information.
         */
        const std::unordered_map<uint32_t, PassInfo> &GetAllPassInfo() const noexcept;
         ...
         * 
         * @param
         * name The name of the shader variable to retrieve.
         * @param pass_index The index of the pass to
         * retrieve the shader variable from.
         * @return const ShaderVariable & A constant reference to the
         * ShaderVariable struct associated with the specified name and pass index.
         */
        ...
        /**
         * @brief Get a shader descriptor variable (textures, UBOs, SSBOs, etc.) by index for a specific
         * pass index.
         * 
         ...
         * @return const
         * DescVar & A constant reference to the DescVar struct associated with the specified index and pass index.
 */
        const DescVar &GetDescVariable(uint32_t index, uint32_t pass_index) const;

        /**
         * @brief Get a shader in-block variable (floats, matrices, etc.) by index for a specific pass
         * index.
         * 
         * @param index The index of the shader variable to retrieve.
         * @param
         * pass_index The index of the pass to retrieve the shader variable from.
         * @return const InblockVar &
         * A constant reference to the InblockVar struct associated with the specified index and pass index.
         */
         ...
         * It first
         * checks in-block names, and then descriptor names, so in-block variables 
         * can mask descriptor
         * variables with the same name. In that case a warning would be
         * issued when the material is being
         * created.
         * 
         ...
         * @return (uint32_t, bool) The
         * index associated with the specified name and pass index,
         * and whether the variable is a in-block
         * variable (floats, etc) or not.
         */
        std::optional<std::pair<uint32_t, bool>> GetVariableIndex(
         ...
         * @param memory Buffer. It should
         * ideally be large enough to avoid memory allocation.
         * @param pass_index
         */
         ...
         * * This method retrieves a vector of pairs containing binding indices and corresponding descriptor image
         * information
         * for a given material instance and pass index. The returned vector can be used to
         * update descriptor sets with images.
         *
         * @param instance The MaterialInstance object from
         * which to retrieve the descriptor image info.
         * @param pass_index The index of the pass for which to
         * retrieve the descriptor image info.
         * @return A vector of pairs, where each pair contains a binding
         * index and a vk::DescriptorImageInfo struct.
         */
