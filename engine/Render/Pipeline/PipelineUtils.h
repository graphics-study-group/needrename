...
namespace Engine {
    ...
    namespace PipelineUtils {
        const static std::unordered_set<std::type_index> REGISTERED_SHADER_UNIFORM_TYPES = {
            typeid(int), typeid(float), typeid(glm::vec4), typeid(glm::mat4)
        };
        ...
        vk::PipelineRasterizationStateCreateInfo ToVulkanRasterizationStateCreateInfo(
            const PipelineProperties::RasterizerProperties &props
        );
        ...
        vk::PipelineDepthStencilStateCreateInfo ToVulkanDepthStencilStateCreateInfo(
            const PipelineProperties::DSProperties &props
        );

        /**
         * Converts a MaterialTemplateSinglePassProperties::Shaders and a default sampler to a list of
        ...
        std::vector<vk::DescriptorSetLayoutBinding> ToVulkanDescriptorSetLayoutBindings(
            const PipelineProperties::Shaders &shaders
        );

        /**
         * Converts a MaterialTemplateSinglePassProperties::Shaders and a vector of unique shader modules to
         * a Vulkan pipeline shader stage create info.
         *
         * @param shaders The shaders to convert.

         * * @param shader_modules The unique shader modules to use for the stages.
         * @return The corresponding
         * Vulkan pipeline shader stage create info.
         */
        vk::PipelineShaderStageCreateInfo ToVulkanShaderStageCreateInfo(
            const PipelineProperties::Shaders &shaders, std::vector<vk::UniqueShaderModule> &shader_modules
        );

        /**
         * Converts a MaterialTemplateSinglePassProperties::Shaders to a Vulkan pipeline layout create
         * info.
         *
         * @param shaders The shaders to convert.
         * @return The corresponding
         ...
         */
        vk::PipelineLayoutCreateInfo ToVulkanPipelineLayoutCreateInfo(const PipelineProperties::Shaders &shaders);

        /**
         * Converts a MaterialTemplateSinglePassProperties::Attachments to a Vulkan pipeline rendering
         * create info.
         *
         * @param attachments The attachments to convert.
         * @return The
         * corresponding Vulkan pipeline rendering create info.
         */
        vk::PipelineRenderingCreateInfo ToVulkanPipelineRenderingCreateInfo(
            const PipelineProperties::Attachments &attachments
        );
    } // namespace PipelineUtils
} // namespace Engine
