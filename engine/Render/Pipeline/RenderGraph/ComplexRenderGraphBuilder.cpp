...
namespace Engine {
    ...
    std::unique_ptr<RenderGraph> ComplexRenderGraphBuilder::BuildEditorRenderGraph(
        ...
        auto &game_bloom = *m_bloom_compute_stage;
        ...
        this->RecordRasterizerPass(
            ...
            {depth_id,
             ...
             AttachmentUtils::StoreOperation::DontCare,
             AttachmentUtils::DepthClearValue{1.0f, 0U}},
            [&system, get_scene_widget_viewport_func, get_scene_camera_index_func](GraphicsCommandBuffer &gcb, const RenderGraph &) {
        ...
        this->RecordRasterizerPass(
            ...
            {depth_id,
             ...
             AttachmentUtils::StoreOperation::DontCare,
             AttachmentUtils::DepthClearValue{1.0f, 0U}},
            [&system, get_game_widget_viewport_func, get_game_camera_index_func](GraphicsCommandBuffer &gcb, const RenderGraph &) {
        ...
        this->RecordRasterizerPass(
            ...
            [gui_system](GraphicsCommandBuffer &gcb, const RenderGraph &) { gui_system->DrawGUI(gcb.GetCommandBuffer()); }
        );

        auto rg{this->BuildRenderGraph()};
        scene_bloom.AssignTexture("inputImage", *rg->GetInternalTextureResource(hdr_color_id));
        scene_bloom.AssignTexture("bloomTemp", *rg->GetInternalTextureResource(bloom_temp_id));
        ...
        game_bloom.AssignTexture("bloomTemp", *rg->GetInternalTextureResource(bloom_temp_id));
