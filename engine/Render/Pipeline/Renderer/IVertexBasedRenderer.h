#ifndef RENDER_PIPELINE_RENDERER_IVERTEXBASEDRENDERER_INCLUDED
#define RENDER_PIPELINE_RENDERER_IVERTEXBASEDRENDERER_INCLUDED
...
#endif // RENDER_PIPELINE_RENDERER_IVERTEXBASEDRENDERER_INCLUDED
