#ifndef RENDER_PIPELINE_RENDERER_STATICHOMOGENEOUSMESH_INCLUDED
#define RENDER_PIPELINE_RENDERER_STATICHOMOGENEOUSMESH_INCLUDED
...
#endif // RENDER_PIPELINE_RENDERER_STATICHOMOGENEOUSMESH_INCLUDED
