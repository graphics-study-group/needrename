...
namespace Engine {
    ...
    namespace RenderSystemState {
        ...
        public:
             ...
             */
            RenderTargetTexture *ResolveHandleToPtr(RRTTHandleEnum handle) noexcept;
             ...
             * created by this manager.
             */
            const RenderTargetTexture::RenderTargetTextureDesc &GetTextureDescription(RRTTHandleEnum handle) const;
             ...
             */
            std::unique_ptr<RenderTargetTexture> ReleaseRTT(RRTTHandleEnum handle) noexcept;
        };
    } // namespace RenderSystemState
