...
namespace Engine {
        ...
        for (uint32_t i = 0; i < 16; i++) {
            ...
            ret.push_back(
                vk::VertexInputBindingDescription{
                    static_cast<uint32_t>(ret.size()), stride, vk::VertexInputRate::eVertex
                }
            );
        }
    ...
    std::vector<vk::VertexInputAttributeDescription> VertexAttribute::ToVkVertexAttribute(
        ...
        for (uint32_t i = 0; i < 16; i++) {
            ...
            ret.push_back(vk::VertexInputAttributeDescription{i, static_cast<uint32_t>(ret.size()), format, 0u});
        }
