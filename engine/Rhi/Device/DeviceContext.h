...
namespace Engine::Rhi {
     ...
     * cache and the GPU resource retirement facility for exactly one device
     * lifetime. Created once by the engine coordinator (MainClass) and shared by
     * RenderSystem and PhysicsSystem.
     *
    ...
    public:
         ...
         * cache and retirement facility on top of it.
         */
