...
Enable solid-color PBR materials via a shader-level `albedoFactor` uniform that multiplies the sampled albedo texture, allowing a single white texture asset to produce any solid color through uniform modulation.
