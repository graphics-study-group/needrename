...
The build system SHALL support separate `meta_<module>` reflection code generation targets per DLL, each generating type registration and serialization code only for headers owned by that module.
