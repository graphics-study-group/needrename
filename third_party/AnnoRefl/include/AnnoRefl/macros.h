#ifndef ANROREFL_MACROS_INCLUDED
#define ANROREFL_MACROS_INCLUDED
...
public:                                                                                                                \
    ...
    REFL_DISABLE virtual void _SERIALIZATION_SAVE_(AnnoRefl::Archive &buffer) const;                                  \
    REFL_DISABLE virtual void _SERIALIZATION_LOAD_(AnnoRefl::Archive &buffer);                                        \
    REFL_ENABLE class_name(AnnoRefl::SerializationMarker marker);
...
public:                                                                                                                \
    friend class AnnoRefl::Registrar;                                                                                  \
    REFL_DISABLE virtual void _SERIALIZATION_SAVE_(AnnoRefl::Archive &buffer) const override;                         \
    REFL_DISABLE virtual void _SERIALIZATION_LOAD_(AnnoRefl::Archive &buffer) override;                               \
    REFL_ENABLE class_name(AnnoRefl::SerializationMarker marker);
...
public:                                                                                                                \
    friend class AnnoRefl::Registrar;                                                                                  \
    REFL_DISABLE void _SERIALIZATION_SAVE_(AnnoRefl::Archive &buffer) const;                                          \
    REFL_DISABLE void _SERIALIZATION_LOAD_(AnnoRefl::Archive &buffer);                                                \
    REFL_ENABLE class_name(AnnoRefl::SerializationMarker marker);
...
#endif // ANROREFL_MACROS_INCLUDED
