#ifndef ANROREFL_UTILS_INCLUDED
#define ANROREFL_UTILS_INCLUDED
...
namespace AnnoRefl {
    /// @brief Wrapper function for deleter.
    /// Format: <void func(the owner object to be deconstructed)>
    using WrapperDeleter = std::function<void(void *)>;
