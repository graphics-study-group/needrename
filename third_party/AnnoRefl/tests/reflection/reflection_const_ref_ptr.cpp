...
#include "meta_annorefl_reflection_const_ref_ptr/reflection_init.inc"
...
void RunReflectionConstRefPtrTest() {
    ...
    AnnoRefl::Var crp_test = AnnoRefl::GetType("TestDataNamespace::ConstTest")->CreateInstance();
    ...
    AnnoRefl::Var data_get = crp_test.InvokeMethod("GetTestDataPtrAndAdd");
    ...
    AnnoRefl::Var const_ref_var = AnnoRefl::GetVar(const_ref);
    AnnoRefl::Var const_data_get = const_ref_var.InvokeMethod("GetConstDataPtr");
