...
#include "meta_annorefl_reflection_method_invoke/reflection_init.inc"
...
void RunReflectionMethodInvokeTest() {
    auto foo_a_type = AnnoRefl::GetType("FooA");
    std::cout << "----------------------------------- Test a FooA var -----------------------------------" << std::endl;
    std::cout << "[] (FooA) Var foo:" << std::endl;
    AnnoRefl::Var foo = foo_a_type->CreateInstance(123, 456);
    ...
    std::cout << "----------------------------------- Test a FooBase var -----------------------------------"
              << std::endl;
    AnnoRefl::Var foo_base = AnnoRefl::GetType("FooBase")->CreateInstance();
    ...
    std::cout << "----------------------------------- Test a FooA as a FooBase* var -----------------------------------"
              << std::endl;
    AnnoRefl::Var foo2_origin = foo_a_type->CreateInstance(5, 7);
    AnnoRefl::Var foo2(AnnoRefl::GetType("FooBase"), foo2_origin.GetDataPtr());
