...
#include "meta_annorefl_reflection_stdint/reflection_init.inc"
...
namespace {
    void RunReflectionStdintTestImpl() {
        auto stdint_type = AnnoRefl::GetType("Test_stdint");
        std::cout << "----------------------------------- Test stdint -----------------------------------" << std::endl;
        std::cout << "[] (Test_stdint) Var stdint:" << std::endl;
        AnnoRefl::Var stdint = stdint_type->CreateInstance();
