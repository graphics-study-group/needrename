...
#include "meta_annorefl_serialization_array_ptr/reflection_init.inc"
...
void RunSerializationArrayPtrTest() {
    ...
    AnnoRefl::serialize(array_ptr_test, archive);

    ArrayPtrTest array_ptr_test2;
    AnnoRefl::deserialize(array_ptr_test2, archive);
