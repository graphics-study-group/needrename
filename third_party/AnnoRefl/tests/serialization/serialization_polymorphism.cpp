...
#include "meta_annorefl_serialization_polymorphism/reflection_init.inc"
...
void RunSerializationPolymorphismTest() {
    ...
    AnnoRefl::serialize(polymorphism_test, archive);

    polymorphism_test.m_vector.clear();
    PolymorphismTest polymorphism_test2;
    AnnoRefl::deserialize(polymorphism_test2, archive);
