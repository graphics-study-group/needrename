...
#include "meta_annorefl_serialization_shared_ptr/reflection_init.inc"
...
void RunSerializationSharedPtrTest() {
    ...
    AnnoRefl::serialize(shared_ptr_test, archive);

    shared_ptr_test.m_shared_ptr.reset();
    SharedPtrTest shared_ptr_test2;
    AnnoRefl::deserialize(shared_ptr_test2, archive);
